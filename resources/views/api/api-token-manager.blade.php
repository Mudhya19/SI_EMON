<div>
        ...
        <x-slot name="form">
            ...
            @if (Laravel\Jetstream\Jetstream::hasPermissions())
                <div class="col-span-6">
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 TindakLanjut-4">
    ...
    <x-jet-dialog-modal wire:model="managinTindakLanjutiTokenPermissions">
        <x-slot name="title">
            {{ __('API Token Permissions') }}
        </x-slot>

        <x-slot name="content">
            <div class="grid grid-cols-1 md:grid-cols-2 TindakLanjut-4">
                @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
                    <label class="flex items-center">
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$set('managinTindakLanjutiTokenPermissions', false)"
    ...
    <x-jet-confirmation-modal wire:model="confirminTindakLanjutiTokenDeletion">
        <x-slot name="title">
            {{ __('Delete API Token') }}
        </x-slot>
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$toggle('confirminTindakLanjutiTokenDeletion')"
                wire:loading.attr="disabled">
                {{ __('Cancel') }}
            </x-jet-secondary-button>
