<div class="accordion" id="triwulanIVAccordion">
    <div class="card">
        <div class="card bg-warning m-lg-2" id="triwulanIVHeader">
            <h5 class="mb-0">
                <button class="btn btn-block btn-link text-left text-light" type="button" data-toggle="collapse"
                    data-target="#triwulanIVCollapse" aria-expanded="true"
                    aria-controls="triwulanIVCollapse">
                    <h6>Triwulan IV</h6>
                </button>
            </h5>
        </div>
        <div id="triwulanIVCollapse" class="collapse"
            aria-labelledby="triwulanIVHeader" data-parent="#triwulanIVAccordion">
            <div class="card-body">
                {{-- isi data table --}}
                <a href="{{ route('report-triwulanIV') }}" target="_blank" method="POST" class="btn btn-success mb-3"><i class="fas fa-fw fa-print"></i>Cetak Data</a>
