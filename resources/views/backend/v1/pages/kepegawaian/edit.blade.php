...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('kepegawaian.update', $kepegawaian) }}" method="POST">
                @csrf
                @method('patch')
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama" id="nama"
                                value="{{ $kepegawaian->nama }}" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="select-single-placeholder form-control" name="jenis_kelamin"
                                id="selectSinglePlaceholder" value="{{ $kepegawaian->jenis_kelamin }}" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir"
                                value="{{ $kepegawaian->tempat_lahir }}" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir"
                                value="{{ $kepegawaian->tanggal_lahir }}" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="agama" id="agama"
                                value="{{ $kepegawaian->agama }}" required>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="select-single-placeholder form-control" name="pendidikan"
                                id="selectSinglePlaceholder" value="{{ $kepegawaian->pendidikan }}" required>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="select-single-placeholder form-control" name="status_perkawinan"
                                id="selectSinglePlaceholder" value="{{ $kepegawaian->status_perkawinan }}" required>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="exampleFormControlTextarea1" name="alamat" rows="6" required>{{ $kepegawaian->alamat }}"</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_telepon" id="no_telepon"
                                value="{{ $kepegawaian->no_telepon }}" required>
                        </div>
                    </div>
                </div>
